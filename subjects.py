    ...
    def get_period_info(self):
        try:
            ...
            for per_info in self.db[self.hall_number]:
                start_time = datetime.datetime.strptime(self.db[self.hall_number][per_info]['time']['from'],
                                                        "%H:%M").time()
                ...
                if start_time <= current_time <= end_time:
                    ...
                    period_info = {"current_period_name": current_period_name, "subject_name": subject_name,
                                   "subject_doctorName": subject_doctorName}
